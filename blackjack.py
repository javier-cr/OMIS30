...
while play_again != 'EXIT':
    ...
    print ("\n\n\n\nYou were dealt the " + card1 + " and the " + card2) #doing this statement first allows for selection between 1 and 11
    ...
    print ('\nThe Dealer deals his/herself one \ncard face up and one card face down')
    print ("First a " + dealer_card1 + " and then a face down card.")
